...
function doStuff(data) {
  ...
  const html = `<h2>Nombre: ${data.name}</h2><h3>Tipo: ${data.types[0].type.name}</h3>
  <h4>Peso: ${data.weight}</h4><h4>Habilidad: ${data.abilities[1].ability.name}</h4><img src="${data.sprites.front_default}" alt="${data.name}">`;
